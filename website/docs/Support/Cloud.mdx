...
my testing. You can use a [port scanner](https://www.ipvoid.com/port-scan/) to test your P2P TCP ports - default `30303` on the execution layer -
...
sudo ufw allow proto udp from any to any port 9000
sudo ufw allow proto udp from any to any port 9001
```
