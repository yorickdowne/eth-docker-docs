...
Total without the storage, case and PSU: ~370 USD. Add a mini-ITX case such as the Silverstone ML05-B ~90 USD and a
PSU like the Seasonic Core BC-650 ~70 USD (way more power than needed, but affordable) and it's ~530 USD for the system.
Plus drive, e.g. WD SN850X 2TB ~360 USD new. All-in ~910 USD.

The board has IPMI and can be steered entirely without monitor and keyboard, just through a web browser. That includes
...
Plus a case, PSU, case fans. Pick your own. Well-liked options are Node 304 (mITX) and Node 804 (uATX)
