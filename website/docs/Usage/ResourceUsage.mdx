...
| Lighthouse | 8.2.2  | September 2026 | ~tbd GiB | ~14 GiB | |
| Lodestar | 1.42.0 | Apr 2026 | ~tbd GiB | ~12 GiB | |
| Nimbus | 26.8.0 | September 2026 | ~90 GiB | ~5 GiB | |
| Prysm | 7.1.3 | Apr 2026 | ~tbd GiB | ~9 GiB | |
...
| Erigon | 3.6.0 | September 2026 | >1.7 TiB | ~tbd TiB | ~590 GiB | ~18 GiB | Erigon will use available system RAM, but the OS will use it for other processes as needed |
