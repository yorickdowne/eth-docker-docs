...
@hughmongas reports that pasta caused issues on a multi-homed server with two or more network connections:
"If you have a dual homed server, you can no longer specify a port with "192.168.1.1:30303:30303" that just will not work,
had to remove the dual home and go 0.0.0.0:30303:30303"
...
It is technically possible to run Eth Docker on [Windows 11](../Support/Windows.mdx).
