...
For a VPS/cloud setup, please take a look at notes on [cloud security](../Support/Cloud.mdx). You'll want to
...
- 30303 TCP/UDP - execution client P2P. Open to Internet.
- 9000 UDP and 9001 UDP - consensus client P2P. Open to Internet.
...
> Steps to allow for this scenario are in [cloud security](../Support/Cloud.mdx)
